...
function getSettings(){
    chrome.storage.sync.get({ removeExplore: false, removeCommunities: true, removeTwitterBlue: true, removeVerifiedOrganizations: true, removeAds: true, removeElonSimps: true, removeMusk: true, removeViews: false, removeBookmarks: false, removeBookmarkButton: true }).then((items) => {
...
document.addEventListener('scroll', ()=>{
    removeTweets(); removeViewsAndBookmarks()});
